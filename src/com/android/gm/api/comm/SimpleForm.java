...
public final class SimpleForm {
	...
	private final String mContentType = "multipart/form-data; boundary="
			+ mBoundary;

	private boolean isClosed;

	// returns itself to support chaining
	public final SimpleForm addFields(Map<String, String> fields)
			throws IOException {
	...
	public final SimpleForm addField(String key, String value) {
		if (!isClosed) {
			...
			throw new IllegalArgumentException(
					"You can not add fields after close has been called.");
		return this;
	}
